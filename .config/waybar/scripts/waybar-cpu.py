...
#: All Credits for (@github/Balthazzahr)[https://gist.github.com/Balthazzahr]
#: Modified by @github/l3tici4g
...
# TODO: !!1 Create the 'colors.toml' in main waybar folder and set Gruvbox theme.
def load_theme_colors():
    theme_path = pathlib.Path.home() / ".config/waybar/colors/colors.toml"
    defaults = {
        "black": "#000000",
        "red": "#ff0000",
        "green": "#00ff00",
...
# TODO: !!2 Set variables colors like 'white = "#fff"' for easy recall.
